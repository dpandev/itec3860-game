...
class MonsterTest {
  ...
  void constructor_nullRoomLocation_handledGracefully() {
    ...
    Monster monster = new Monster("MON-01", "Test", null, "Description", 50, 10, List.of(), List.of());
  ...
  void constructor_zeroHealth_allowed() {
    ...
    Monster monster = new Monster("MON-01", "Test", "RM-01", "Description", 0, 10, List.of(), List.of());
  ...
  void equals_sameId_returnsTrue() {
    Monster monster1 = new Monster("MON-01", "Test1", "RM-01", "Desc1", 50, 10, List.of(), List.of());
    Monster monster2 = new Monster("MON-01", "Test2", "RM-02", "Desc2", 80, 20, List.of(), List.of());
  ...
  void equals_differentId_returnsFalse() {
    Monster monster1 = new Monster("MON-01", "Test", "RM-01", "Description", 50, 10, List.of(), List.of());
    Monster monster2 = new Monster("MON-02", "Test", "RM-01", "Description", 50, 10, List.of(), List.of());
  ...
  void immutability_collectionsAreCopied() {
    ...
    Monster monster = new Monster("MON-01", "Test", "RM-01", "Description", 50, 10, originalEffects, originalDrops);

    // Returned collections should be immutable copies
    assertThrows(UnsupportedOperationException.class, () -> 
        monster.getSpecialEffects().add("Effect2"));
    assertThrows(UnsupportedOperationException.class, () -> 
        monster.getItemDrops().add("IT-02"));
  }
}
